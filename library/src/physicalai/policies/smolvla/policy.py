...
from physicalai.export.mixin_policy import ExportablePolicyMixin as _BaseExportablePolicyMixin
...
setattr(_BaseExportablePolicyMixin, "to_onnx", SmolVLA.to_onnx)
