...
class SmolVLAModel(ExportableModelMixin, Model):
    ...
    def extra_export_args(self) -> dict[str, ExportParameters]:
        ...
        onnx_args: ExportParameters = ONNXExportParameters(
            exporter_kwargs={
                "output_names": ["action"],
            },
            export_tokenizer=True,
        )
        cast("Any", onnx_args).preprocessing_type = "smolvla"
        extra_args["onnx"] = onnx_args
        ...
        cast("Any", openvino_args).preprocessing_type = "smolvla"
